...
def zad1_single_neuron(student_id):
    ...
    # JA: sam ustaw wagi, "wydedukuj ręcznie"
    w1, w2, b1 = 8, -8, -5.5
    model.W[:, 0] = [w1, w2]
    model.b[:] = [b1]
...
def zad2_two_layer_net(student_id):
    ...
    model.output_layer.b[:] = [-1.8]         # bias neuronu wyjściowego
...
if __name__ == '__main__':
    ...
    student_id = 193208         # Twój numer indeksu, np. 102247
